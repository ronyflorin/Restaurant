      ...
      $$('.form-product-has-subproducts').each(function (sp) {
          sp.observe('click', function () {
              if (sp.checked) {
                  ...
                  JotForm.populateProductValues(sp, selectedValues);
              } else {
                  ...
                  JotForm.clearProductValues(sp, selectedValues);
              }
              JotForm.totalCounter(JotForm.prices);
          });
      });
    ...
    initDateV2Inputs: function() {
        ...
        for(var i = 0; i < liteModeInputs.length; i++) {
            try {
                var imask = new Inputmask({
                    alias: 'datetime',
                    inputFormat: liteModeInputs[i].placeholder.toLowerCase(),
                    jitMasking: true,
                });
        ...
        if (fitbInputs && fitbInputs.length > 0) {
            Array.from(fitbInputs).forEach(function(fitbInput) {
                ...
                fitbInput.addEventListener('input', function() {
                    ...
                    fitbInput.style.width = Math.max(width, initWitdh) + 'px';
